...
public class InventoryTransferDto {
    ...
    @NotNull(message = "Kho di khong duoc de trong")
    private Long fromWarehouseId;

    @NotNull(message = "Kho den khong duoc de trong")
    ...
    @NotEmpty(message = "Phieu dieu chuyen phai co it nhat 1 dong san pham")
